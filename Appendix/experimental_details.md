...
[^azamfirei2023hallucinations]: Large language models and the perils of their hallucinations
[^wang2022self]: Self-consistency improves chain of thought reasoning in language models
[^talmor2018web]: The web as a knowledge-base for answering complex questions
[^jiang2016timekg]: Towards time-aware knowledge graph completion
[^wadden2020fact]: Fact or fiction: Verifying scientific claims
[^Wikinews]: [Refer to specific citation](https://en.wikinews.org/wiki/Wikinews:Archives)
[^berant2013webquestion]: Semantic parsing on freebase from question-answer pairs
